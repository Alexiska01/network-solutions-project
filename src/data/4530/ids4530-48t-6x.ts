export const ids4530_48t_6x = {
  modelUrl: "https://s3.twcstorage.ru/c80bd43d-3dmodels/S4530-48T.glb",
  ...
  specifications: {
    ...
    performance: {
      ...
      items: [
        { label: "Коммутационная способность", value: "376 Gbps" },
        { label: "Пропускная способность", value: "280 Mpps" },
        { label: "Flash-память", value: "8 GB" },
        { label: "ОЗУ", value: "2 GB" },
        { label: "IPv4 маршрутов", value: "632K" },
        { label: "IPv6 маршрутов", value: "383K" }
      ]
    },
    ...
    power: {
      ...
      items: [
        { label: "Источник питания", value: "Два встроенных блока питания от сети переменного тока" },
    ...
    physical: {
      ...
      items: [
        { label: "Размеры (Ш×Г×В)", value: "442×420×44.2 мм" },
        { label: "Вес", value: "≈4.6 кг" },
