        ...
        <div className="max-w-7xl mx-auto py-3 px-3 xs:px-4 sm:px-6 lg:px-[35px]">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>IDS3730-24T-6X</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-4 md:p-6 shadow-xl">
                ...
                <div className="space-y-3 md:space-y-4">
                  {ids3730_24t_6x.basicSpecs.map((spec, index) => (
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-8 md:mb-16">
            ...
            <p className="text-sm md:text-lg text-gray-600 max-w-3xl mx-auto px-4">
              Детальная информация обо всех параметрах и возможностях коммутатора IDS3730-24T-6X
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
            {ids3730_24t_6x.specGroups.map((specGroup, index) => (
              <div 
                key={index} 
...
export default ModelIDS3730_24T_6XComponent;