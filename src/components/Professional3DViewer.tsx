          ...
          >
            <div className="relative w-full h-full">
              <button
                ...
                className="absolute top-6 right-6 bg-black/50 hover:bg-black/70 text-white p-3 rounded-xl transition-all z-10"
              >
                <Icon name="X" size={24} />
              </button>
              ...
              {/* Fullscreen Controls */}
              <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 bg-black/50 backdrop-blur-md rounded-xl p-4 flex items-center gap-4">
                <button
                  onClick={toggleRotation}
                  className={`p-2 rounded-lg transition-all ${
