    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold mb-6 font-sans">Продукты</h3>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-gray-400 hover:text-[#00B5AD] transition-colors font-sans"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Solutions */}
          <div>
            <h3 className="text-lg font-bold mb-6 font-sans">Решения</h3>
            <ul className="space-y-3">
              {solutions.map((link) => (
                <li key={link.path}>
                  <Link
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-bold mb-6 font-sans">Контакты</h3>
