...
const Hero3530 = () => {
  useEffect(() => {
    const img = new Image();
    img.src = "/img/Иерархия_3530.png";
  }, []);

  return (
    <section className="bg-gradient-hero text-white py-6 sm:py-8 md:py-12 lg:py-16 xl:py-20 relative overflow-hidden h-[600px] flex items-center">
