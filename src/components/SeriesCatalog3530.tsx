...
const SeriesCatalog3530Component = () => {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
            <div>
              <h1 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-bold mb-3 md:mb-4 lg:mb-6 leading-tight transition-all duration-300 hover:scale-105 hover:drop-shadow-lg cursor-default">
                ...
                <span className="block text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-normal mt-2">
      ...
      {/* Benefits Section */}
      <motion.section
        className="py-16 bg-gradient-to-b from-gray-50/30 to-white"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <p className="text-sm text-gray-600 font-sans">
                Надёжное питание устройств любого типа
              </p>
            </motion.div>
            <motion.div
              className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
            ...
            >
              ...
              <p className="text-sm text-gray-600 font-sans">
                Высокоскоростное подключение к магистрали
              </p>
            </motion.div>
            <motion.div
              className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
            ...
            >
              ...
              <p className="text-sm text-gray-600 font-sans">
                Стабильная работа 24/7 в любых условиях
              </p>
            </motion.div>
            <motion.div
              className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
            ...
            >
              ...
              <p className="text-sm text-gray-600 font-sans">
                Полная поддержка маршрутизации
              </p>
            </motion.div>
          </div>
        </div>
