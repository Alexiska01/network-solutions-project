    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-hero text-white py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-sm md:text-base lg:text-lg xl:text-xl mb-6 sm:mb-8 text-slate-300 w-[90%] md:w-[70%] mx-auto leading-relaxed font-sans">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-base md:text-lg lg:text-xl font-semibold mb-2 font-sans">
                PoE/PoE+ до 760 Вт
              </h3>
              <p className="text-sm md:text-base lg:text-lg xl:text-xl text-gray-600 leading-normal font-sans w-[90%] md:w-[70%] mx-auto">
