              ...
              {item.items?.map((subItem, subIndex) => (
                ...
                >
                  {subItem.items && subItem.items.length > 0 ? (
                    <div className="relative flex items-center rounded-xl text-sm border border-gray-100 w-full overflow-hidden bg-white">
                      {/* Decorative Dot */}
                      <div className="w-2 h-2 rounded-full bg-gray-300 ml-4 mr-3 flex-shrink-0" />
                      
                      {/* Clickable text area - goes to page */}
                      <Link
                        to={subItem.path}
                        className="flex-1 py-4 font-medium text-gray-800 no-underline relative"
                        onClick={() => {
                      ...
                      >
                        ...
                        {/* Page icon indicator - always visible */}
                      ...
                      <button
                        ...
                        className="py-4 px-4 text-blue-500 active:bg-blue-600 active:text-white transition-colors duration-200 touch-manipulation relative bg-blue-50"
                      >
                        {/* Icon - always visible */}
