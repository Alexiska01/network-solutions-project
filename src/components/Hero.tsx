            ...
            <div className="relative w-full max-w-xs sm:max-w-sm lg:max-w-md mx-auto">
              ...
              <div className="block lg:hidden">
                ...
                >
                  ...
                  <motion.div
                    className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl border border-white/25 rounded-2xl p-4 text-center"
                    whileHover={{ scale: 1.05 }}
                  >
                    <div className="w-8 h-8 bg-emerald-400/20 rounded-lg mx-auto mb-2 flex items-center justify-center">
                      <Icon
                        name="Wifi"
                        size={16}
                  ...
                  {/* Простая карточка скорости */}
                  <motion.div
                    className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl border border-white/25 rounded-2xl p-4 text-center"
                    whileHover={{ scale: 1.05 }}
                  >
                    <div className="w-8 h-8 bg-blue-400/20 rounded-lg mx-auto mb-2 flex items-center justify-center">
                      <Icon name="Zap" size={16} className="text-blue-300" />
                    </div>
                    <div className="text-white text-sm font-bold">0.8ms</div>
                    <div className="text-white/70 text-xs">Latency</div>
                  </motion.div>
                </motion.div>

                {/* Простая полоса производительности */}
                <motion.div
                  className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl border border-white/25 rounded-2xl p-4"
