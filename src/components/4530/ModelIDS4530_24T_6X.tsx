...
import { ids4530_24t_6x } from "@/data/4530/ids4530-24t-6x";

const ModelIDS4530_24T_6XComponent = () => {
        ...
        <div className="max-w-7xl mx-auto py-3 px-3 xs:px-4 sm:px-6 lg:px-[35px]">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>IDS4530-24T-6X</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
          ...
          <div className="space-y-6 lg:space-y-0 lg:grid lg:grid-cols-5 lg:gap-12 lg:items-start">
            ...
            <div className="lg:col-span-3">
              <Professional3DViewer
                ...
                modelPath={ids4530_24t_6x.modelUrl}
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-4 md:p-6 shadow-xl">
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 md:py-3 border-b border-white/10 last:border-b-0 gap-1 sm:gap-0">
                    ...
                    <span className="text-white font-semibold text-sm md:text-base">24×100/1000M Base-T</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 md:py-3 border-b border-white/10 last:border-b-0 gap-1 sm:gap-0">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 md:py-3 border-b border-white/10 last:border-b-0 gap-1 sm:gap-0">
                    ...
                    <span className="text-white font-semibold text-sm md:text-base">328 Gbps</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 md:py-3 border-b border-white/10 last:border-b-0 gap-1 sm:gap-0">
                    <span className="text-white/70 font-medium text-sm md:text-base">Питание:</span>
                    <span className="text-white font-semibold text-sm md:text-base">2x AC PSU (integrated)</span>
                  </div>
                </div>
              </div>
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-8 md:mb-16">
            ...
            <p className="text-sm md:text-lg text-gray-600 max-w-3xl mx-auto px-4">
              Детальная информация обо всех параметрах и возможностях коммутатора IDS4530-24T-6X
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
            {[
              { spec: ids4530_24t_6x.specifications.ports, icon: "Network" },
              { spec: ids4530_24t_6x.specifications.poe, icon: "Zap" },
              { spec: ids4530_24t_6x.specifications.performance, icon: "Zap" },
              { spec: ids4530_24t_6x.specifications.physical, icon: "Settings" },
              { spec: ids4530_24t_6x.specifications.power, icon: "Shield" },
              { spec: ids4530_24t_6x.specifications.environmental, icon: "Thermometer" }
            ].map((specGroup, index) => (
              <div 
                key={index} 
...
export default ModelIDS4530_24T_6XComponent;