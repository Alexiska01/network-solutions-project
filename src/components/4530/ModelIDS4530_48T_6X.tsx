...
import { ids4530_48t_6x } from "@/data/4530/ids4530-48t-6x";

const ModelIDS4530_48T_6XComponent = () => {
        ...
        <div className="max-w-7xl mx-auto py-3 px-3 xs:px-4 sm:px-6 lg:px-[35px]">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>IDS4530-48T-6X</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 md:py-12 lg:py-20">
          ...
          <div className="text-center mb-8 md:mb-12 lg:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/80 font-light max-w-3xl mx-auto px-4 sm:px-0">
              Управляемый коммутатор уровня L3 с 48 портами Ethernet и высокой производительностью
            </p>
          </div>
          ...
          <div className="space-y-6 lg:space-y-0 lg:grid lg:grid-cols-5 lg:gap-12 lg:items-start">
            ...
            <div className="lg:col-span-3">
              <Professional3DViewer
                ...
                modelPath={ids4530_48t_6x.modelUrl}
            ...
            <div className="lg:col-span-2">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-4 md:p-6 shadow-xl">
                ...
                <div className="space-y-3 md:space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 md:py-3 border-b border-white/10 last:border-b-0 gap-1 sm:gap-0">
                    <span className="text-white/70 font-medium text-sm md:text-base">Поддержка PoE:</span>
                    <span className="text-white font-semibold text-sm md:text-base">Нет</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 md:py-3 border-b border-white/10 last:border-b-0 gap-1 sm:gap-0">
              ...
              <div className="mt-4 md:mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                <div className="bg-gradient-to-br from-[#00B5AD]/20 to-[#0065B3]/20 backdrop-blur-sm rounded-xl border border-[#00B5AD]/20 p-3 md:p-4">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-sm font-semibold text-white">48 портов</span>
                  </div>
                  <p className="text-xs text-white/80">Высокая плотность портов</p>
                </div>
                <div className="bg-gradient-to-br from-[#0065B3]/20 to-[#1A2980]/20 backdrop-blur-sm rounded-xl border border-[#0065B3]/20 p-3 md:p-4">
                  <div className="flex items-center mb-2">
                    <Icon name="Zap" className="h-4 w-4 md:h-5 md:w-5 text-[#0065B3] mr-2" />
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-8 md:mb-16">
            ...
            <p className="text-sm md:text-lg text-gray-600 max-w-3xl mx-auto px-4">
              Детальная информация обо всех параметрах и возможностях коммутатора IDS4530-48T-6X
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
            {[
              { spec: ids4530_48t_6x.specifications.ports, icon: "Network" },
              { spec: ids4530_48t_6x.specifications.poe, icon: "Zap" },
              { spec: ids4530_48t_6x.specifications.performance, icon: "Zap" },
              { spec: ids4530_48t_6x.specifications.physical, icon: "Settings" },
              { spec: ids4530_48t_6x.specifications.power, icon: "Shield" },
              { spec: ids4530_48t_6x.specifications.environmental, icon: "Thermometer" }
            ].map((specGroup, index) => (
              <div 
                key={index} 
...
export default ModelIDS4530_48T_6XComponent;