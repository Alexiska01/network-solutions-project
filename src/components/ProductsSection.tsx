...
const ProductsSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-3 sm:py-4 md:py-8 lg:py-10 bg-gradient-to-b from-gray-200/80 to-gray-100/90 relative overflow-hidden flex items-center">
