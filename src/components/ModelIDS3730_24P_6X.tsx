...
import { ids3730_24p_6x } from "@/data/ids3730-24p-6x";

const ModelIDS3730_24P_6XComponent = () => {
    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto py-3 px-3 xs:px-4 sm:px-6 lg:px-[35px]">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link to="/products/switches/ids3730">IDS3730</Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>IDS3730-24P-6X</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <section className="relative bg-gradient-hero text-white overflow-hidden">
        ...
        <div className="absolute top-6 left-6 z-30">
          <Button
            variant="ghost"
            onClick={() => navigate("/products/switches/ids3730")}
          ...
          <div className="space-y-6 lg:space-y-0 lg:grid lg:grid-cols-5 lg:gap-12 lg:items-start">
            ...
            <div className="lg:col-span-3">
              <Professional3DViewer
                ...
                modelPath={ids3730_24p_6x.modelPath}
            ...
            <div className="lg:col-span-2">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-4 md:p-6 shadow-xl">
                ...
                <div className="space-y-3 md:space-y-4">
                  {ids3730_24p_6x.basicSpecs.map((spec, index) => (
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-8 md:mb-16">
            ...
            <p className="text-sm md:text-lg text-gray-600 max-w-3xl mx-auto px-4">
              Детальная информация обо всех параметрах и возможностях коммутатора IDS3730-24P-6X
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
            {ids3730_24p_6x.specGroups.map((specGroup, index) => (
              <div 
                key={index} 
          ...
          <div className="mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-3 md:p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-xs md:text-sm text-gray-600">Работа в диапазоне температур от -5°C до +45°C</p>
            </div>
          </div>
        </div>
      </section>
...
export default ModelIDS3730_24P_6XComponent;