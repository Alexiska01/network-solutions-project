        ...
        <div className="max-w-7xl mx-auto px-3 md:px-6 lg:px-8">
          ...
          <div className="mb-4">
            {(() => {
              ...
              useEffect(() => {
                observeElement(cardRef.current, 4);
              }, [observeElement]);

              return (
                <div
                  ref={cardRef}
                  className={`group bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-sm hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] transition-all duration-700 hover:-translate-y-1 hover:scale-[1.02] border border-gray-100 hover:border-[#00BEAD]/20 max-w-md mx-auto ${
                    isVisible(4)
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-5"
                  }`}
